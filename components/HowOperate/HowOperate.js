...
function HowOperate() {
    return (
      <div className={styles.containerHowOperate}>
        <div>
        ...
        <div className={styles.HowOperateGrid}>
          ...
          <h4 className={styles.description}>Pagá con criptomonedas</h4>
            <p>
                ...
                contract P2P), en el cuál se asegurarán tus activos, hasta que el vehículo se encuentre totalmente bajo tu dominio.
            </p>
          </div>
          <div className={styles.HowOperate}>
